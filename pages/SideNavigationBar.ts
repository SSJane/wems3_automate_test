...
class SideNavigationBar {
  ...
  constructor(page: Page) {
    ...
    // Files Menu
    this.filesMenu = page.locator('a[title="Files"][href="#"]');
  ...
  // Function navifation to sub-menu by parent menu and sub-menu name
  async navigateTo(parentMenu: string, subMenu: string) {
    // Click parent menu first
    switch (parentMenu) {
      case "Files":
        await this.clickFilesMenu();
        break;
      case "Access Control":
        await this.clickAccessControlMenu();
        break;
      case "Settings":
        await this.clickSettingsMenu();
        break;
      case "Security":
        await this.clickSecurityMenu();
        break;
      case "Help":
        await this.clickHelpMenu();
        break;
      default:
        throw new Error(`Parent menu "${parentMenu}" not found.`);
    }

    // Click sub-menu
    switch (subMenu) {
      case "My Cases":
        await this.clickMyCasesMenu();
        break;
      case "My Favorites":
        await this.clickMyFavoritesMenu();
        break;
      case "My Bookmarks":
        await this.clickMyBookmarksMenu();
        break;
      case "My Photos":
        await this.clickMyPhotosMenu();
        break;
      case "My Videos":
        await this.clickMyVideosMenu();
        break;
      case "My Audio":
        await this.clickMyAudioMenu();
        break;
      case "My Documents":
        await this.clickMyDocumentsMenu();
        break;
      case "All Files":
        await this.clickAllFilesMenu();
        break;
      case "Shared Files":
        await this.clickSharedFilesMenu();
        break;
      default:
        throw new Error(`Sub-menu "${subMenu}" not found.`);
    }
  }
